  ...
  return (
    <>  
        ...
        <div className='flex md:flex-row relaive justify-between w-3/5 items-center m-auto mt-5 xs:flex-col xs:gap-5 '>
            ...
            <div className='flex md:w-3/5 align-middle'>
                 <Link to='/Income'  className='bg-black text-white md:w-[28rem] md:m-0 md:h-16 font-raleway font-thin text-2xl transition duration-300 ease-in-out hover:scale-x-110 hover:scale-y-110 hover:bg-white hover:text-black hover:border hover:border-black align-middle justify-center flex text-center pt-4 xs:w-80 xs:h-12 xs:mx-16  ' >
                    View Income
                </Link>
            </div>
            <div className='flex items-center align-middle'>
                 <Link to='/Expense' className='bg-black text-white md:w-[28rem] md:ml-5 md:h-16 font-raleway font-thin text-2xl transition duration-300 ease-in-out hover:scale-x-110 hover:scale-y-110 hover:bg-white hover:text-black hover:border hover:border-black justify-center flex text-center pt-4 xs:w-80 xs:h-12 '>
                    View Expense
                </Link>
            </div>
        </div>
